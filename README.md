...
- 🚀 Composite Blur provides several highly optimized [blur algorithms](#blur-algorithms) including [Gaussian](#gaussian), [Multi-Pass Box](#box), [Dual Kawase](#dual-kawase-dual-filter), and [Pixelate](#pixelate). Composite Blur also support Windows, MacOS, and Linux for *all* blur types.
